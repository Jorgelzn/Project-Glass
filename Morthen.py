...
class morthenFrame(mainFrame):
    ...
    def __init__(self, parent,prevDiaryEntry):
        super().__init__(parent,"images//landscapes/morthen/morthen.jpg","music/morthen.mp3",prevDiaryEntry+"""-Me encuentro ante un enorme muro de hielo\n""","morthen1","texts/morthen")
