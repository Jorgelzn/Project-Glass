...
class iretZarFrame(mainFrame):
    ...
    def __init__(self, parent,prevDiaryEntry):
        super().__init__(parent,"images/landscapes/iret-zar/iret-zar.jpg",["texts/iret-zar.txt"],"music/desert.mp3",prevDiaryEntry+"""-Parece que este desierto no tiene final\n""",5,"iretzar1")
