...
class kanilikFrame(mainFrame):
    ...
    def __init__(self, parent,prevDiaryEntry):
        super().__init__(parent,"images/landscapes/kanilik/selvaKanilik.jpg",["texts/kanilik.txt"],"music/elfos nocturnos.mp3",prevDiaryEntry+"""-Nunca antes habia visto una selva como esta\n""",3,"kanilik1")
